...
public class HomeController {
	...
	*/
	...
	public ModelAndView logIn(@ModelAttribute MailBean mail) {
	
		return smail.entrance(mail);
	...
	public ModelAndView toDate(@ModelAttribute Movie mv) {
	   ...
	   public String toTime(@ModelAttribute Movie mv) throws UnsupportedEncodingException {
	      ModelAndView mav = reservation.entrance(mv);
	   ...
	   public ModelAndView toSeat(@ModelAttribute Movie mv) {
	      ...
	      System.out.println(mv.getToDate());
	      System.out.println(mv.getSI_SCREEN());
