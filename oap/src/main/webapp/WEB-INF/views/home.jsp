...
<body onload="init()">
	<nav class="container">
		<ul class="nav-container" id="con">
			<li><a href="#"><img src="/resources/img/logo.png"
					width="228px" height="62px"></a></li>
			<li class="nav-item"><div class="show" onclick="fnMove(0)">오시는
					길</div></li>
			<li class="nav-item"><a href="#">사용후기</a></li>
			<li class="nav-item"><a href="#">주요 기능</a></li>

			<li class="nav-item-regist"><a href="/LogInForm?sCode=3"><img
					class="test1" src="/resources/img/register_btn.png" width="140px"
					height="50px"></a></li>
		</ul>
	...
	<section class="section">
		<div class="main">
			<div class="main_image">
				<span class="main_title">알바어때?</span><br> <span
					class="main_title_contents1">생활의 질이 올라갑니다. </span>
				<div class="main_title1">
					<img src="/resources/img/main_title1.png" width="519px"
						height="258px" />
				</div>
				<div class="main_title2">
					<img src="/resources/img/main_title2.png" width="750px"
						height="503px" />
				</div>
			</div>
			<div class="main_btn">
				<a class="login_btn" href="/LogInForm?sCode=1"><img
					src="/resources/img/admin_btn.png" width="120px" height="120px"></a>
				<a class="alba_btn" href="/LogInForm?sCode=2"><img
					src="/resources/img/alba_btn.png" width="120px" height="120px"></a>
				<a class="register_btn" href="/LogInForm?sCode=3"></a><img
					src="/resources/img/register_btn2.png" width="120px" height="120px"></a>
			</div>
		</div>
	</section>
	<div class="container">
		<section>
			<div id="comment"></div>
			<div id="map"></div>
			<a href="http://kko.to/jaxXKOIDB" target="_blank" title="다음 지도로 연결 "><div
					class="btn_Yellow">다음지도로 연결</div></a>
			<div id="howTo"></div>
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c12ddaa519ac1f1f821e84ef032ac15d&libraries=services"></script>
<script type="text/javascript"
